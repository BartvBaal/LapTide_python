...
class straddle_t:
    ...
    def search_general (self, init_x, op, obs):
        itt = 0
    ...
    def search_lin (self, init_x, verbose=False):
        if verbose is True:
            return self.search_general(init_x, lin, obs_print_t())
        else:
            return self.search_general(init_x, lin, obs_empty_t())

    def search_log (self, init_x, verbose=False):
        if verbose is True:
            return self.search_general(init_x, log, obs_print_t())
        else:
            return self.search_general(init_x, log, obs_empty_t())
